...
import { Controller,Delete, Post, Body, Get, Query, UseInterceptors, UploadedFiles, InternalServerErrorException, BadRequestException, Param, Put, Patch, Res } from '@nestjs/common';
...
async deleteAppointment(@Param('id') id: string) {
  try {
    ...
    return { message: 'Appointment deleted successfully', result };
  } catch (error) {
